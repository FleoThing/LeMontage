...
| `speed` | Slow-motion / fast-forward by a playback factor |
...
└── engine/
    ...
    │   └── captions.py  export.py  concat.py  speed.py
...
> detection, cutting, captions, export, speed) with channels, matrix, caching and
